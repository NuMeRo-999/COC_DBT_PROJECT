...
WITH player_data AS (
    SELECT
        raw:tag::VARCHAR AS player_id,
        raw:clan:tag::VARCHAR AS clan_id,
        ...
        TRY_TO_TIMESTAMP(raw:clan:joinedClanAt) AS joined_clan_at,
        TRY_TO_TIMESTAMP(raw:leftClanAt) AS left_clan_at,
